...
{
    public partial class frmQuestion5b : Form
    {
        // Generate random numbers
        Random random = new Random();
        int RandomNumber = 0;

        public frmQuestion5b()
        {
            InitializeComponent();
            ...
            // States that this question has been used.
            Globalvariables.CompletedQuestionsB [4] = true;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Globalvariables.QuestionsCorrectB [4] = true;
