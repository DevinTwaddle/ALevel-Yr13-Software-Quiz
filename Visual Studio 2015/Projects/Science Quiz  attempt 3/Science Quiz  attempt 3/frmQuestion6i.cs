...
namespace Science_Quiz__attempt_3
{
    ...
    public partial class frmQuestion6i : Form
    {
        // These bools will be used to determine whether or not the question is correct
        ...
        {
            // Add a point for each question thats correct.
            if (Answer [0] == true)
            {
           ...
           if (Answer[0] == true && Answer[1] == true)
            {
                Globalvariables.QuestionsCorrectI [5] = true;
            }
        ...
        private void AnswerCheck_Tick(object sender, EventArgs e)
        {
            // These blocks of code will chekc to see if the user has answered correctly.
            // 1st textbox.
            if (textBox1.Text == "Geocentric")
            {
                Answer[0] = true;
            }
            else if (textBox1.Text == "geocentric")
            {
                Answer[0] = true;
            }
            else
            ...
            // 2nd textbox.
            if (textBox2.Text == "heliocentric")
            {
                Answer[1] = true;
            }
            else if (textBox2.Text == "Heliocentric")
            {
                Answer[1] = true;
            }
            else
