...
{
    public partial class frmQuestion2i : Form
    {
        // This bool is used to determine whether or not the answers are correct
        ...
        private void btnContinue_Click(object sender, EventArgs e)
        {
            ...
            // all ansers are correct
            if (Answer[0] == true && Answer[1] == true && Answer[2] == true)
            {
                Globalvariables.QuestionsCorrectI[1] = true;
            }
        ...
        // This block of code will check the users answers, and decide if they are correct.
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listBox1.Text == "Vacuum") // if the selected answer = 28, then bool = true
            {
                Answer[0] = true;
            }
        }
        ...
        {
            if (listBox2.Text == "Oxygen") // if correct answer is selected bool = true
            {
                Answer[1] = true;
            }
        }
