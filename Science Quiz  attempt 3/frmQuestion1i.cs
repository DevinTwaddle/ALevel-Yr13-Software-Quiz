...
{
    public partial class frmQuestion1i : Form
    {
        ...
        public frmQuestion1i() // The code is put into this section, so that it will run when the form is loaded.
        {
            InitializeComponent();

            // Tell the system that this form has been used
            Globalvariables.CompletedQuestionsI[0] = true;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Globalvariables.QuestionsCorrectI[0] = true;
